...
//       setPrescription(response.data.medications)
...
//             <path fillRule="evenodd" d="M10 2a4 4 0 00-4 4 4 4 0 004 4 4 4 0 004-4 4 4 0 00-4-4zM5 10a5 5 0 015-5 5 5 0 015 5 5 5 0 01-5 5 5 5 0 01-5-5zm0 7a3 3 0 013-3h4a3 3 0 013 3v2H5v-2z" clipRule="evenodd" />
//           </svg>
//         </div>
//       </header>
...
//             </label>
//             {previewUrl && <img src={previewUrl} alt="Prescription Preview" className="mt-4 w-32 h-32 object-cover rounded-md" />}
//           </div>

//           <button onClick={handleSend} className="mt-4 w-full py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-all">
...
export default function HomePage() {
  ...
  //     console.log("Response:", response.data.data.medications);
  //     alert(`Prescription uploaded successfully!`);
  //     setMedications(response.data.data.medications); // Update state with medications data
  //   } catch (error) {
  //     console.error("Error uploading prescription:", error);
  //     alert("Failed to upload prescription. Please try again.");
  //   } finally {
      ...
      <div className="flex flex-1 w-[80%] mx-auto p-8 gap-12">
        ...
        <div className="w-full md:w-1/2 bg-white p-8 rounded-lg shadow-lg border border-gray-200">
          ...
          {loading ? (
            ...
            <p className="text-gray-600">
              No details available. Please upload a prescription.
            </p>
          )}
        </div>
      </div>
